...
export interface ApiArticleArticle extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    ufLink: Schema.Attribute.String & Schema.Attribute.Unique;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiFolkFolk extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::folk.folk'> &
      Schema.Attribute.Private;
...
export interface ApiFylkeslederFylkesleder extends Struct.CollectionTypeSchema {
  collectionName: 'fylkesledere';
  info: {
    description: 'Fylkesledere og kontaktinformasjon som vises p\u00E5 kontaktsiden';
    displayName: 'Fylkesleder';
    pluralName: 'fylkesledere';
    singularName: 'fylkesleder';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    contactMail: Schema.Attribute.Email & Schema.Attribute.Required;
...
export interface ApiMemeMeme extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::meme.meme'> &
      Schema.Attribute.Private;
    memeImage: Schema.Attribute.Media<'images' | 'files'> &
      Schema.Attribute.Required;
    memeTitle: Schema.Attribute.String &
      Schema.Attribute.Unique &
      Schema.Attribute.SetMinMaxLength<{
        maxLength: 30;
        minLength: 3;
...
declare module '@strapi/strapi' {
  export namespace Public {
    export interface ContentTypeSchemas {
      ...
      'api::fylkesleder.fylkesleder': ApiFylkeslederFylkesleder;
